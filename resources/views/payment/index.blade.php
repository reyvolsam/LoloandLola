                    ...
                    <div class="col-md-5" ng-if = "vm.payment.apply_advance_payment == 1">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type = "text" class = "form-control" id = "advance_payment" aria-describedby = "advance_payment" ng-model = "vm.payment.advance_payment" ng-change = "vm.ChangeAdvancePayment()" ng-currency ng-focus = "vm.OnFocusAdvancePayment()" />
                            </div><!--/input-group-->
                        </div><!--/form-group-->
                    </div>
                </div>
