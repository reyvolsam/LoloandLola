...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('statics/js/customs/dating/list.js') }}"></script>
@stop
...
<div class="row">
    <div class="col-md-12" ng-init = "vm.InitLoad()">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title t_left">Lista de Citas</h4>
                        ...
                        <table class = "table">
                            ...
                            <tbody ng-repeat = "cita in vm.cita.slots_list" ng-init = "cont = $index">
                                <tr ng-class = "($index % 2 === 0) ? 'table-active' : ''">
                                    ...
                                    <td><button ng-if = "cita.exist_cita == true" class = "btn btn-success" ng-click = "vm.GoToPayment(cita.user_slot_id)"><i class = "fa fa-credit-card"></i></button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div><!--/col-md-5-->
